...
const EnrollForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    mobile: '',
    course: course || {}  // Include the selected course in formData
  });
  ...
  return (
    <div className="enroll-form">
      {!bookingDetails ? (
        ...
        <p>Course Name: {bookingDetails.course && bookingDetails.course.courseName ? bookingDetails.course.courseName : 'Course information not available'}</p>
